...
// Known variables: $description, $start, $duration, $tags, $project.
// Unknown $foo tokens pass through literally as '$foo' in the output.
// No code evaluation — regex substitution only (eliminates CR-01).
